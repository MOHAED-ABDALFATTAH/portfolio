...
// --- DUMMY DATA (Ideally, move this to its own file, e.g., `lib/data.ts`) ---
// This makes your portfolio incredibly easy to update. Just change the data here.
...
const portfolioData = {
  ...
  contact: {
    ...
    linkedin: "https://linkedin.com/in/mohamed-a-abdalfattah", // Use a real or plausible link
  },
  about: {
    summary:
  ...
  education: {
    ...
    courses: "Data Structures, Algorithms, Software Engineering, Embedded Systems, Database Management",
  },
  skills: [
    {
    ...
    },
    {
      ...
      items: ["Node.js", "React", "Express.js", "Git/GitHub", "VS Code", "Unit Testing", "Debugging"],
    },
     {
      category: "Data & AI",
  ...
  projects: [
    {
      ...
      description: "Developed a full-stack web application featuring user authentication, real-time booking, and an admin dashboard for fleet management. Built with HTML, CSS, JavaScript, and a robust SQL backend.",
      link: "https://github.com/MOHAED-ABDALFATTAH/Car-Rental-System", // Example link
    },
    {
      title: "Bus Reservation System",
      description: "Engineered a secure and high-performance backend using Node.js, Express, and MongoDB. Implemented a RESTful API for handling bookings, user data, and route management.",
      link: "https://github.com/MOHAED-ABDALFATTAH/Bus-Reservation", // Example link
    },
    {
      title: "Review Paper: Attention Mechanisms",
      description: "Authored a comprehensive literature survey titled 'Attention Mechanisms in Machine Learning,' analyzing seminal papers and their impact on modern Natural Language Processing (NLP) and Computer Vision (CV) models.",
      link: "#", // Link to the paper if available
    },
  ],
  certifications: [
  ...
  achievements: [
    {
      ...
      description: "Led a team to victory by designing and programming an autonomous robot.",
    },
    {
      title: "3rd Place – Egypt’s National Quantum Hackathon (IQAFE 2025)",
      description: "Collaborated on a novel quantum algorithm for optimization problems.",
    },
    {
      title: "ECPC Participant",
      description: "Competed in the Egyptian Collegiate Programming Contest, honing advanced problem-solving and algorithmic skills under pressure.",
    },
  ],
};
